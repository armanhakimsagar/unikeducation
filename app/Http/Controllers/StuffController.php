...
class StuffController extends Controller
{
    ...
    public function list3(){
        $champion = data::where("allocated_id","champion")->get();
    	return view('stuff/champion',compact('champion'));
    }

    public function champion_update(Request $request){
   ...
   public function details3($id){
        $champion = data::where("id",$id)->get();
        return view('stuff/champion_details',compact('champion'));
    }    

    public function list4(){
    	$solder = data::where("allocated_id","solder")->get();
        return view('stuff/solder',compact('solder'));
    }

   public function details4($id){
    	$solder = data::where("id",$id)->get();
        return view('stuff/solder_details',compact('solder'));
    }

    public function solder_update(Request $request){
