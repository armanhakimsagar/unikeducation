						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
									...
									<form>
										Event Name : <input type="text" name="" class="form-control"> <br>

										Date : <input type="text" name="" class="form-control"><br>

										Description : <input type="text" name="" class="form-control"><br>
										Upload Event Image : <input type="file" name="pic"><br>
										<br>
										<input type="submit" name="" class="btn btn-success" value="Create Event">
