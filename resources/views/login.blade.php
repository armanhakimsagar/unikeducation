...
<html lang="en">
	...
	<body>
		...
		<section class="blog_area section_padding" id="blog">
			...
			<div class="container">
			<div class="col-md-6 col-sm-6 col-xs-12" style="border-right:1px solid #ccc; padding: 10px">
				...
				<div class="panel panel-default">
				  <div class="panel-heading"><h4>Already Have A Account ? </h4>
				<br>
			  ...
			  <form method="post" action="{{ url('studentLogin') }}">
			    ...
			    <div class="form-group">
			      ...
			      <input type="text" required class="form-control" id="pwd" placeholder="Enter Email" name="email">
			    </div>

			    <div class="form-group">
			      <label for="pwd">Phone:</label>
			      <input type="text" required class="form-control" id="phn" placeholder="Enter Phone" name="phone">
			    </div>
			 ...
			 <div class="col-md-6 col-sm-6 col-xs-12" style=" padding: 10px">
                ...
                @endif
			 	<div class="panel panel-default">
			       <div class="panel-heading"><h4>Don't have any account ? </h4>
				<br>
				<h5>Register Here</h5></div>
				
				
			    </div>
			  <form action="{{ url('RegistrationVerify') }}" method="post">
                {{ csrf_field() }}
			    <div class="form-group">
			      <label for="email">Name:</label>
			      <input type="text" required class="form-control" id="text" placeholder="Enter Name" name="name">
			    ...
			    <div class="form-group">
			      <label for="pwd">Phone:</label>
			      <input type="text" required class="form-control" id="pwd" placeholder="Enter Phone" name="phone">
			    </div>
                 <input type="hidden" name="code" value="<?php echo $rand = rand(1,1000000) ?>">
