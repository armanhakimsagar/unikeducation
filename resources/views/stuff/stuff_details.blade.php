			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<form action="{{ url('warrior/submit') }}" method="post">
									{{ csrf_field() }}

									@foreach($warrior_id as $d)
									<div class="container">
									<div class="container">
...
<br>
										...
										<div class="row">
											<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
												<div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
													<input type="text" class="form-control" name="master" placeholder="Masters" value="{{ $d->master }}">
												</div>
												<div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
...
<br>
										...
										<div class="row">
											<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
												<div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
													<input type="text" class="form-control" name="others" value="{{ $d->others }}" placeholder="Any Other Diploma">
												</div>
												<div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
